...
def add_new_doctor():
    ...
    response = add_doctor(data, request_data["surname"], request_data["name"], request_data["room"], request_data["specialty"], request_data["patients"])
...
def update_doctor():
    data = load_data()
    request_data = request.json
    response = edit_doctor(data, request_data["surname"], request_data["name"], request_data["updated_info"])
    return jsonify(response)
